...
- 🔄 **Phase 2** — พอร์ต UI page logic (`components/pages/*`):
  - ✅ ภาพรวม(Dashboard) · จัดการสต็อก · โอนเข้าร้าน · วัตถุดิบ · สูตรขนม · บันทึกขาย
  - ⬜ เคลม · วิเคราะห์ · จัดการผู้ใช้ (ยัง scaffold — lib function พร้อมแล้ว)
